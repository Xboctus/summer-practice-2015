    ...
    <section class="content">
      <div class="row">
        <section class="col-lg-12">
          <a name="button" class="btn btn-default btn-sm" href="/registration">Registration</a>
          <form:form method="POST" action="/authAction" class="form-horizontal"  commandName="user">
